package Zlib.Checksums is
   function Adler32
     (Adler : Interfaces.C.unsigned_long;
      Buf   : System.Address;
      Len   : Interfaces.C.int) return Interfaces.C.unsigned_long;
   function Adler32_Combine
     (Adler1 : Interfaces.C.unsigned_long;
      Adler2 : Interfaces.C.unsigned_long;
      Len2   : Interfaces.C.unsigned_long) return Interfaces.C.unsigned_long;
   function Crc32
     (Crc : Interfaces.C.unsigned_long;
      Buf : System.Address;
      Len : Interfaces.C.unsigned_long) return Interfaces.C.unsigned_long;
